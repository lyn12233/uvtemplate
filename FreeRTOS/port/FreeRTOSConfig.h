...
//  <q>Use tickless idle
//  <i> Enable low power tickless mode to stop the periodic tick interrupt
//  during idle periods or <i> disable it to keep the tick interrupt running at
//  all times. <i> Default: 0
...
//  required when stack checking is enabled. <i> Default: 0
...
//  semaphore structures and display associated text names. <i> Default: 0
...
//  <o>Tasks functions
//  <i> Define event recording level bitmask for events generated from Tasks
//  functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
#define configEVR_LEVEL_TASKS 0x05

//  <o>Queue functions
//  <i> Define event recording level bitmask for events generated from Queue
//  functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
...
//  <o>Timer functions
//  <i> Define event recording level bitmask for events generated from Timer
//  functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
...
//  <i> Define event recording level bitmask for events generated from Event
//  Groups functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
#define configEVR_LEVEL_EVENTGROUPS 0x05

//  <o>Heap functions
//  <i> Define event recording level bitmask for events generated from Heap
//  functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
...
//  <i> Define event recording level bitmask for events generated from Stream
//  Buffer functions. <i> Default: 0x05
//    <0x00=>Off <0x01=>Errors <0x03=>Errors + API <0x05=>Errors + Operation
//    <0x07=>Errors + API + Operation <0x0F=>All
...
//  <i> When enabled RTOS objects can be created using RAM automatically
//  allocated from the FreeRTOS heap. <i> Default: 1
#define configSUPPORT_DYNAMIC_ALLOCATION 1

//  <q>Use kernel provided static memory
//  <i> When enabled FreeRTOS kernel provides static memory for Idle and Timer
//  tasks. <i> Otherwise user shall provide implementation of: <i> -
//  vApplicationGetIdleTaskMemory and vApplicationGetTimerTaskMemory <i> -
//  vApplicationGetPassiveIdleTaskMemory (when kernel uses SMP) <i> Default: 1
#define configKERNEL_PROVIDED_STATIC_MEMORY 1

//  <q>Use application allocated heap
//  <i> Global heap buffer must be provided externally when using application
//  allocated heap. <i> The buffer must be declared as: uint8_t ucHeap[
//  configTOTAL_HEAP_SIZE ]. <i> Default: 0
#define configAPPLICATION_ALLOCATED_HEAP 0

//  <q>Use separate heap for stack allocation
//  <i> Enable or disable stack allocation for any task from a separate heap.
//  <i> Thread-safe implementation of pvPortMallocStack and vPortFreeStack is
//  required when using separate heap. <i> Default: 0
#define configSTACK_ALLOCATION_FROM_SEPARATE_HEAP 0

//  <q>Use heap protector
//  <i> Enable or disable bounds checking and obfuscation to heap block
//  pointers. <i> This setting only applies to Heap_4 and Heap_5. <i> Default: 0
...
//  definition. <i> This setting is only relevant on ARMv8-M MPU enabled ports.
//  <i> Default: 0
...
//  <i> Enable TrustZone when FreeRTOS runs on the Non-Secure side and calls
//  functions from the Secure side. <i> This setting is only relevant on ARMv8-M
//  ports. <i> Default: 1
#define configENABLE_TRUSTZONE 1

//  <o>Minimal secure stack size [words] <0-65535>
//  <i> Stack for idle task Secure side context in words.
//  <i> This setting is only relevant on ARMv8-M ports when TrustZone extension
//  is enabled. <i> Default: 128
#define configMINIMAL_SECURE_STACK_SIZE ((uint32_t)128)

//  <h>Interrupt Controller Configuration
//  <i> Configure Arm Generic Interrupt Controller (GIC) interrupt controller
//  specific settings. <i> Settings related to interrupt controller are relevant
//  only on ARMv7-A ports.
...
//   <i> Must be set to the offset from interrupt controller base address at
//   which the CPU interface starts. <i> Default: 0x1000
#define configINTERRUPT_CONTROLLER_CPU_INTERFACE_OFFSET 0x00001000UL

//   <o>Interrupt controller unique priorities
//   <i> The number of unique priorities that can be specified in the interrupt
//   controller peripheral. <i> Default: 32
...
//  <i> Enable callback function call on each idle task iteration.
//  <i> Callback function vApplicationPassiveIdleHook implementation is required
//  when idle hook is enabled. <i> Default: 0
...
/* Maximum API call interrupt priority:
   - Interrupts assigned a priority at or below this priority can call interrupt
   safe FreeRTOS API function, and will nest.
   - Interrupts assigned a priority above this priority will not be effected by
   RTOS critical sections, and will nest, but cannot call any FreeRTOS API
   functions.
   - Use configMAX_SYSCALL_INTERRUPT_PRIORITY to set this define as they are
...
#define configCLEAR_TICK_INTERRUPT() OS_Tick_AcknowledgeIRQ()
#else
/* Cortex-M specifics */
