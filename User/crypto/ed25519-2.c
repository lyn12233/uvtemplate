...
static crypto_uint32 fe25519_equal(crypto_uint32 a,
                                   crypto_uint32 b) /* 16-bit inputs */
{
...
static const crypto_uint32 sc25519_m[32] = {
    0xED, 0xD3, 0xF5, 0x5C, 0x1A, 0x63, 0x12, 0x58, 0xD6, 0x9C, 0xF7,
    0xA2, 0xDE, 0xF9, 0xDE, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10};

static const crypto_uint32 sc25519_mu[33] = {
    0x1B, 0x13, 0x2C, 0x0A, 0xA3, 0xE5, 0x9C, 0xED, 0xA7, 0x29, 0x63,
...
static void add_p1p1(ge25519_p1p1 *r, const ge25519_p3 *p,
                     const ge25519_p3 *q) {
  fe25519 a, b, c, d, t;
...
int crypto_sign_ed25519_keypair(unsigned char *pk, unsigned char *sk) {
  ...
  // NOTE: this is untested to replace upper 3 lines
  raw_pub_from_raw_material(pk, az);
...
int crypto_sign_ed25519(unsigned char *sm, unsigned long long *smlen,
  ...
  *smlen = mlen + 64;
  ...
  raw_pub_from_raw_material64(sm, nonce);
  puts("sig::nonce");
  buff_dump(nonce, 64);
  puts("sig::sig");
  buff_dump(sm, 32);
